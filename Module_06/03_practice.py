...
while piter.content < TOTAL_CARGO:
    hour += 1
    print(Fore.RED + '------------------ Час {} ------------------'.format(hour))
    truck_1.act()
    truck_2.act()
    loader_1.act()
    loader_2.act()
    moscow.act()
    piter.act()
    print(Fore.CYAN + truck_1)
    print(Fore.CYAN + truck_2)
    print(Fore.CYAN + loader_1)
    print(Fore.CYAN + loader_2)
    print(Fore.CYAN + moscow)
    print(Fore.CYAN + piter)
