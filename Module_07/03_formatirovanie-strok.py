...
class Team:
    ...
    def __init__(self, name, quantity_of_members):
        ...
        self.total_score = 0
        self.count_of_solved_task = 0
        self.count_of_task = -1
        self.time = 0
    ...
    def __eq__(self):
        return self.count_of_solved_task
...
print(f'\nКоманды решили {team1.count_of_solved_task} и {team2.count_of_solved_task} задач.')
win_team = max(team1, team2)
print(win_team)
